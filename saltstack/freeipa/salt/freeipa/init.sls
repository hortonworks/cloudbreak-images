...
freeipa-cipa:
  cmd.run:
    - name: python3 -m pip install --user 'pyasn1==0.5.1' --ignore-installed && python3 -m pip install --user 'pyasn1-modules==0.3.0' --ignore-installed && python3 -m pip install --user 'checkipaconsistency==2.7.10'
