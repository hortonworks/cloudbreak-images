...
build-aws-centos7: 
	@ METADATA_FILENAME=$(METADATA_FILENAME) make build-aws-centos7-base
	$(ENVS) \
...
generate-last-metadata-url-file:
	echo "METADATA_URL=https://raw.githubusercontent.com/$(GITHUB_ORG)/$(GITHUB_REPO)/master/$(METADATA_FILENAME).json" > last_md
