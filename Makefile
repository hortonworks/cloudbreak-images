...
DEFAULT_FREEIPA_PLUGIN_RPM_URL := "http://cloudera-build-us-west-1.vpc.cloudera.com/s3/build/48919567/thunderhead/1.x/redhat8/yum/cdp-hashed-pwd-1.0-20240104200644git7e13294.el7.x86_64.rpm"

# This one is OS-independent
DEFAULT_FREEIPA_HEALTH_AGENT_RPM_URL := "http://cloudera-build-us-west-1.vpc.cloudera.com/s3/build/48919567/thunderhead/1.x/redhat8/yum/freeipa-health-agent-0.1-20240104200644git7e13294.x86_64.rpm"

# This one is OS-independent
DEFAULT_FREEIPA_LDAP_AGENT_RPM_URL := "http://cloudera-build-us-west-1.vpc.cloudera.com/s3/build/49050621/thunderhead/1.x/redhat8/yum/freeipa-ldap-agent-1.0.0-b12325.x86_64.rpm"
