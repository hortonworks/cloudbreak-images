...
HDC_CLI_VERSION ?= $(CBD_VERSION)
ENVS=CBD_VERSION=$(CBD_VERSION) CBD_VERSION_UNDERSCORE=$(CBD_VERSION_UNDERSCORE) BASE_NAME=$(BASE_NAME) HDC_CLI_VERSION=$(HDC_CLI_VERSION) TRACE=1
