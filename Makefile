...
DEFAULT_FREEIPA_PLUGIN_RPM_URL := "https://cloudera-build-us-west-1.vpc.cloudera.com/s3/build/45750751/thunderhead/1.x/redhat8/yum/cdp-hashed-pwd-1.0-20230930103632gitd59af99.el7.x86_64.rpm"

# This one is OS-independent
DEFAULT_FREEIPA_HEALTH_AGENT_RPM_URL := "https://cloudera-build-us-west-1.vpc.cloudera.com/s3/build/45750751/thunderhead/1.x/redhat8/yum/freeipa-health-agent-0.1-20230930103632gitd59af99.x86_64.rpm"

# This one is OS-independent
DEFAULT_FREEIPA_LDAP_AGENT_RPM_URL := "https://cloudera-build-us-west-1.vpc.cloudera.com/s3/build/45750751/thunderhead/1.x/redhat8/yum/freeipa-ldap-agent-1.0.0-b11536.x86_64.rpm"
