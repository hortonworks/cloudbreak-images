...
DEFAULT_METERING_AGENT_RPM_URL := "https://cloudera-build-us-west-1.vpc.cloudera.com/s3/build/41354158/thunderhead/1.x/redhat8/yum/thunderhead-metering-heartbeat-application-1.0.0-b10381.x86_64.rpm"
DEFAULT_FREEIPA_PLUGIN_RPM_URL := "https://cloudera-build-us-west-1.vpc.cloudera.com/s3/build/41354158/thunderhead/1.x/redhat8/yum/cdp-hashed-pwd-1.0-20230523080151git217371f.x86_64.rpm"
DEFAULT_FREEIPA_HEALTH_AGENT_RPM_URL := "https://cloudera-build-us-west-1.vpc.cloudera.com/s3/build/41354158/thunderhead/1.x/redhat8/yum/freeipa-health-agent-0.1-20230523080151git217371f.x86_64.rpm"
DEFAULT_FREEIPA_LDAP_AGENT_RPM_URL := "https://cloudera-build-us-west-1.vpc.cloudera.com/s3/build/41354158/thunderhead/1.x/redhat8/yum/freeipa-ldap-agent-1.0.0-b10381.x86_64.rpm"
