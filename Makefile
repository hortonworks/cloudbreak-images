...
build-openstack-redhat9:
	...
	OPENSTACK_PROJECT_DOMAIN_ID=$(OPENSTACK_PROJECT_DOMAIN_ID) \
	OPENSTACK_USER_DOMAIN_ID=$(OPENSTACK_USER_DOMAIN_ID) \
	CB_OPENSTACK_CLI_TOOLS_VERSION="1.0.0" \
...
ifeq ($(AZURE_INITIAL_COPY),true)
	TRACE=1 AZURE_STORAGE_ACCOUNTS=$(AZURE_BUILD_STORAGE_ACCOUNT) ./scripts/azure-managed-image-to-blob.sh
endif
