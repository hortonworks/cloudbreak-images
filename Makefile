...
DEFAULT_JUMPGATE_AGENT_RPM_URL := "https://cloudera-build-us-west-1.vpc.cloudera.com/s3/build/27062362/inverting-proxy/1.x/redhat7/yum/tars/inverting-proxy/jumpgate-agent.rpm"  
