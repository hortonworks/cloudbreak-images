...
function delete_unnecessary_files() {
  ...
  find /opt/salt_3000.2/lib/python3.7/site-packages/salt/modules/ -name "*lxd*" -exec rm -f {} \;
  find /opt/salt_3000.2/lib/python3.7/site-packages/salt/modules/ -name "*vsphere*" -exec rm -f {} \;
  find /opt/salt_3000.2/lib/python3.7/site-packages/salt/modules/ -name "*boto3_elasticsearch*" -exec rm -f {} \;
  find /opt/salt_3000.2/lib/python3.7/site-packages/salt/modules/ -name "*win_*" -exec rm -f {} \;
}
