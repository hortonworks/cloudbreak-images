...
function install_salt_with_pip3() {
  ...
  python3 -m pip install msgpack pyyaml looseversion packaging distro jinja2 cryptography zmq cherrypy virtualenvwrapper markupsafe jinja2 tornado PyOpenSSL salt==${SALT_VERSION}
  #requests
#virtualenvwrapper
#CherryPy
#pyzmq==${PYZMQ_VERSION}
...
#msgpack-python
#PyOpenSSL
  #python3 -m pip install CherryPy pyOpenSSL msgpack pyyaml looseversion packaging distro jinja2 salt==${SALT_VERSION}
